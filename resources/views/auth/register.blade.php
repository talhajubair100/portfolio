                ...
                <div class="card">
                    ...
                    <form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group mb-3 row">
                            <div class="col-12">
                                <input class="form-control" type="text" id="name" required="" placeholder="First Name" name="name" :value="old('name')" required autofocus>
                            </div>
                        </div>

                        <div class="form-group mb-3 row">
                            <div class="col-12">
                                <input class="form-control" type="text" id="username" required="" placeholder="User Name" name="username" :value="old('username')" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3 row">
                            <div class="col-12">
                                <input class="form-control" type="password" required="" placeholder="Confirm Password" id="password_confirmation" name="password_confirmation"
                                required>
                            </div>
                        </div>
