                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3">
                            ...
                            @csrf
                                ...
                                Forgot your password? No problem. Just let us know your <strong>E-mail</strong>  address and we will <strong>E-mail</strong>  you a password reset link that will allow you to choose a new one.
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
    
                                <div class="form-group mb-3">
                                    <div class="col-xs-12">
                                        <input id="email" class="form-control" type="email" required="" placeholder="Email" name="email" :value="old('email')" required autofocus >
                                    </div>
                                </div>
